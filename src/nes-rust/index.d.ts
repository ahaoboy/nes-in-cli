...
export interface InitOutput {
  ...
  readonly __wbg_wasmnes_free: (a: number) => void;
  readonly wasmnes_new: () => number;
  readonly wasmnes_set_rom: (a: number, b: number, c: number) => void;
  readonly wasmnes_bootup: (a: number) => void;
  readonly wasmnes_reset: (a: number) => void;
  readonly wasmnes_step: (a: number) => void;
  readonly wasmnes_step_frame: (a: number) => void;
  readonly wasmnes_update_pixels: (a: number, b: number, c: number) => void;
  readonly wasmnes_update_sample_buffer: (
    a: number,
    b: number,
    c: number
  ) => void;
